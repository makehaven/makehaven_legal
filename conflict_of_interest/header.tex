...
\setromanfont[Ligatures=Common,Mapping=tex-text,Numbers=OldStyle,Scale=MatchLowercase]{Hoefler Text}
...
\titleformat{\subsection}[display]{}{}{0pt}{\textbf{\thesubsection}\quad#1}
